...
if __name__ == "__main__":
    ...
    parser.add_argument("--prompt", type=str, default='My hands reach out, fingers brushing the soft surface of a flour bag before I pull it open. I watch the flour spill out, drifting gently onto the countertop beneath me. The flour clouds my view for a moment, settling in a fine dust. I place my palms on the dough, feeling its texture—slightly sticky, smooth, and pliable. As I press down and fold, I can see my hands work the dough, the gentle motion of my fingers kneading it, shaping it into a ball. I watch closely as the flour clings to my hands, dusting my fingers with a fine layer. The countertop stretches in front of me, the edges of the wooden surface visible, along with a few utensils and a stove in the background. Everything around me is in my line of sight, as I focus intently on the task, my movements smooth and deliberate.', help="The description of the video to be generated")
    parser.add_argument(
        "--image_or_video_path",
        type=str,
        default=None,
